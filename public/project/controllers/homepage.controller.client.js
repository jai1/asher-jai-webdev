...
(function () {
    ...
    function Controller($interval, $routeParams, $http, HomePageService) {
        ...
        vm.popularStoryTypes = [{displayName: "Most Emailed", type: "mostemailed"},
            {displayName: "Most Shared", type: "mostshared"},
            {displayName: "Most Viewed", type: "mostviewed"}];

        vm.getPopularStories = function (type) {
        ...
        vm.topStoryTypes = [   {displayName: "All", type: "home"},
        ...
        vm.getTopStories = function (type) {
        ...
        vm.movieTypes = [{displayName: "Currently Showing", type: "picks"}, {displayName: "All Movies", type: "all"}];
